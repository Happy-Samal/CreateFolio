...
function Login() {
  ...
  return (
    <>
      <Helmet>
        <title>CreateFolio - Login your account</title>
      ...
      <div className="fixed inset-0 flex  justify-center bg-black bg-opacity-20 backdrop-blur-[3px] z-50 text-white">
            <div className=" relative sm:top-28 top-24 text-center border-2 rounded-xl h-[80vh] py-12 sm:px-8">
                ...
                {/* login  in buttons */}
                <div className="flex flex-col gap-5 px-7 py-10 sm:px-10 items-center ">
                    {/* Google */}
                    <button
                        className="flex items-center bg-white w-[250px] sm:w-[290px] border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500  hover:bg-black hover:text-white transition-colors duration-500 ease-in-out" onClick={handleGoogleLogin} >
                    ...
                    {/* linkedIn */}
                    <button
                        className="flex items-center bg-gray-500 w-[250px] sm:w-[290px] border  rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-500  cursor-default  ">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                    ...
                    {/* Facebook */}
                    <button
                        className="flex items-center bg-white w-[250px] sm:w-[290px] border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500  hover:bg-black hover:text-white transition-colors duration-500 ease-in-out" onClick={handleFacebookLogin}>
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                    ...
                    {/* Github */}
                    <button
                        className="flex items-center bg-white w-[250px] sm:w-[290px] border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500  hover:bg-black hover:text-white transition-colors duration-500 ease-in-out" onClick={handleGithubLogin}>
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
